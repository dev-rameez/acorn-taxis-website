# Home — Elementor section copy

**Page settings:** Elementor Canvas or Default · set as homepage  

**Cab9:** `https://booker.cab9.app?company=ACO&code=0951`  
**Tel:** `tel:+44182763333`
...
- App Store → Apple URL  
- Text link: Learn more → /download-our-app/
...
**Button:** Areas covered → /areas-covered/
...
**Placeholder:** Insert Google Reviews widget when Place ID / embed code is supplied. Until then, link:  
Find Acorn Taxis on Google  

Do **not** invent star ratings or fake quotes.
...
A: Book online, use the Acorn Taxis app, or call 01827 63333. Private hire journeys must be pre-booked.

**Q: Are you open overnight?**  
A: Yes. We are open 24/7.

**Q: Can I pay by card?**  
A: Yes. You can pay by cash, by card in the app, or by card in the vehicle. Let us know your preferred payment method when you book if you need card payment in the vehicle.

**Q: Do you go to the airport?**  
A: Yes. We provide transfers to major airports including Birmingham, Manchester, Heathrow, Luton and East Midlands.

**Q: Can I book by email?**  
A: No. Please book online, through the app, or by phone. Use the contact form for general enquiries only.
...
**Text:** Book online in a few steps, or speak to our team now.

**Buttons:** Book Online · Call 01827 63333  

**Note (small):** Please note all our calls are recorded for training and monitoring purposes.
